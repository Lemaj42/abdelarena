...
const PlayerCard = ({ player }) => {
    ...
    return (
        <div key={player.id} className="card col-lg-2 col-md-4 col-sm-12 card center" id={`joueur${player.id}`}>
            {player.pv > 0 ? (
                <div className={`card card-${player.name}`}>
                    ...
                    <div className="container text-center">
                        <div className="row justify-content-center" style={{ opacity: displayStyle }}>
                            <div className='col-3'>
